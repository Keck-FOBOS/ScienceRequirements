...
The U.S.\ has invested more than \$4B in ambitious imaging projects that will obtain unprecedented deep, wide, and high-cadence multi-epoch photometry of billions of sources. Unfortunately, the U.S.\ is unprepared to make full use of these data because there is no spectroscopic facility capable of collecting the large and deep spectral data sets needed to anchor imaging-based analyses.  This has long-recognized consequences to the primary science goals of these surveys, such as a 20–40\% loss in the constraining power of the Dark Energy figure-of-merit (equivalent to a $\sim$\$1B investment loss).  Aimed at addressing this loss and the more general need for spectroscopic capacity on 8--10m-class telescopes in the 2030s, this document presents transformational science programs used to specify science requirements for a new facility-class spectrograph for the W.M.\ Keck Observatory.  Building from a few baseline instrument capabilities,  these ``design-reference'' science programs address key questions about the nature of Dark Energy and Dark Matter, the intergalactic and circumgalactic media, the evolutionary history of the Local Group and, specifically, the Andromeda Galaxy, and capitalize on the promise of time-domain and multi-messenger astronomy via ``at-the-ready'' followup spectroscopy at faint magnitudes.  The science requirements stemming from these programs result in instrument specifications for the uniquely capable Fiber-Optic Broadband Optical Spectrograph (FOBOS) for Keck II.
...
0A & 2021-04-22 & Kyle Westfall & CoDR Internal Review \\ \bottomrule
\end{tabular}}
\end{table}
