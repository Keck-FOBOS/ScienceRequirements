...
\hspace*{0.5cm} Clear nights: 62.5 \\
\hspace*{0.5cm} Program Duration: 5 years
}
...
\hspace*{0.5cm} Clear nights: 25 \\
\hspace*{0.5cm} Program Duration: 3 years 
}
...
\hspace*{0.5cm} Clear nights: 13.5 \\
\hspace*{0.5cm} Program Duration: 5 years (integrate into Dark Energy Program)
}
...
\hspace*{0.5cm} Clear nights: 12.5 \\
\hspace*{0.5cm} Program Duration: 2 years
}
...
\hspace*{0.5cm} Clear nights: Integrated into other programs \\
\hspace*{0.5cm} Program Duration: ongoing
}
...
\edit{Fold in M31 satellites to following paragraph.}
...
%  - 
\noindent \textbf{FOBOS Andromeda Program \& Requirements: \\
\hspace*{0.5cm} Clear nights: 86 \\
\hspace*{0.5cm} Program Duration: 5 years
}
...
\reqitem Stellar age precision for M31 and M33 disk stars must $<$0.1 dex as inferred via, e.g., use of the blue CN absorption features \citep[e.g.][]{Martig16,Ting19}.  %This typically requires S/N $\approx$ 30 per pixel at $R=1800$.
...
\noindent \textbf{FOBOS M31 Cluster Program \& Requirements: \\
\hspace*{0.5cm} Clear nights: 15  \\
\hspace*{0.5cm} Program Duration: 3 years or integrate within M31 Program
}
...
\begin{sciencerequirement}
\reqitem \edit{IFU multiplex.  What is the cluster on-sky surface density?}
\reqitem \edit{IFU size and fill factor.}
\end{sciencerequirement}
...
%   - 
%   - 
\noindent \textbf{FOBOS Dark Matter Program \& Requirements: \\
\hspace*{0.5cm} Clear nights: 15 \\
\hspace*{0.5cm} Program Duration: 3 years
}
